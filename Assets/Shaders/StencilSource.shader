    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                if (_HoleBoxCount > 0 && IsInsideBox(i.worldPos, _HoleBox0_Min.xyz, _HoleBox0_Max.xyz))
                    discard;
                if (_HoleBoxCount > 1 && IsInsideBox(i.worldPos, _HoleBox1_Min.xyz, _HoleBox1_Max.xyz))
                    discard;
